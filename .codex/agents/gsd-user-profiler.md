...
<reference>
@C:/code/manager-class/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/code/manager-class/.codex/gsd-core/references/user-profiling.md` to load:
