...
<required_reading>
@C:/code/manager-class/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/code/manager-class/.codex/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/code/manager-class/.codex
                  → checks C:/code/manager-class/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/code/manager-class/.codex/gsd-core
                  → writes to C:/code/manager-class/.codex/gsd-core/hooks/
...
@C:/code/manager-class/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @C:/code/manager-class/.codex/gsd-core/references/common-bug-patterns.md
