...
<execution_context>
@C:/code/manager-class/.codex/gsd-core/workflows/manager.md
...
Read and execute `C:/code/manager-class/.codex/gsd-core/workflows/analyze-dependencies.md` end-to-end.
