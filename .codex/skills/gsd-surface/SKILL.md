...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/code/manager-class/.codex/.gsd-surface.json`
(sibling to `C:/code/manager-class/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/code/manager-class/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`C:/code/manager-class/.codex/skills`).
...
`C:/code/manager-class/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/code/manager-class/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/code/manager-class/.codex/.gsd-surface.json`
Install profile marker: `C:/code/manager-class/.codex/.gsd-profile`
Skill dirs: `C:/code/manager-class/.codex/skills/gsd-*/`
Engine module: `C:/code/manager-class/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/code/manager-class/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
