...
- @C:/code/manager-class/.codex/gsd-core/workflows/complete-milestone.md (main workflow)
- @C:/code/manager-class/.codex/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
