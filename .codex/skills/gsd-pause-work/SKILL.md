...
<execution_context>
@C:/code/manager-class/.codex/gsd-core/workflows/pause-work.md
</execution_context>
...
Read and execute `C:/code/manager-class/.codex/gsd-core/workflows/session-report.md` end-to-end.
