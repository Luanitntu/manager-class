...
<template>
@C:/code/manager-class/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/code/manager-class/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/code/manager-class/.codex/gsd-core/workflows/transition.md`.
...
- Follow @C:/code/manager-class/.codex/gsd-core/workflows/diagnose-issues.md
