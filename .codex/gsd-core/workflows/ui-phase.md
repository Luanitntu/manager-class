...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/code/manager-class/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-ui-checker.md for instructions.
