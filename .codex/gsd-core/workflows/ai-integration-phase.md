...
<required_reading>
@C:/code/manager-class/.codex/gsd-core/references/ai-frameworks.md
@C:/code/manager-class/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/code/manager-class/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/code/manager-class/.codex/agents/gsd-eval-planner.md for instructions.
