...
ones). Reference: @C:/code/manager-class/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/code/manager-class/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/code/manager-class/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/code/manager-class/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/code/manager-class/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/code/manager-class/.codex/gsd-core/templates/spec.md.
