...
See C:/code/manager-class/.codex/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/code/manager-class/.codex/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/code/manager-class/.codex/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/code/manager-class/.codex/gsd-core/templates/discovery.md
...
Use C:/code/manager-class/.codex/gsd-core/templates/discovery.md.
