...
Key references:
- @C:/code/manager-class/.codex/gsd-core/references/ui-brand.md (display patterns)
- @C:/code/manager-class/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/code/manager-class/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md" "C:/code/manager-class/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/code/manager-class/.codex/gsd-core/references/user-profiling.md`
...
Reference: @C:/code/manager-class/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/code/manager-class/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at C:/code/manager-class/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/code/manager-class/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="C:/code/manager-class/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    C:/code/manager-class/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   C:/code/manager-class/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        C:/code/manager-class/.codex/AGENTS.md
```
