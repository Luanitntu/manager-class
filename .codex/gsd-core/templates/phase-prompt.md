...
<!-- For checkpoint task examples and patterns, see @C:/code/manager-class/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/code/manager-class/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/code/manager-class/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/code/manager-class/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
