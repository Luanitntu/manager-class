...
.app-initial-loader__brand-mark {
  align-items: center;
...
.app-initial-loader__calendar::before {
...
.app-initial-loader__calendar i {
...
.app-initial-loader__calendar i:nth-child(2n) {
  animation-delay: 140ms;
}

.app-initial-loader__calendar i:nth-child(3n) {
  animation-delay: 280ms;
}

.app-initial-loader__copy {
  display: grid;
  gap: 8px;
}

.app-initial-loader__eyebrow {
...
.app-initial-loader__progress span {
...
.app-initial-loader__preview-bar {
  align-items: center;
  display: flex;
  gap: 10px;
}

.app-initial-loader__preview-bar span {
  background: var(--loader-primary);
  border-radius: 8px;
  height: 34px;
  width: 34px;
...
.app-initial-loader__preview-bar strong {
  background: #eaf1fb;
  border-radius: 8px;
  display: block;
  height: 18px;
...
.app-initial-loader__week {
  display: grid;
  gap: 8px;
  grid-template-columns: repeat(5, 1fr);
}

.app-initial-loader__week span {
  background: #f1f5f9;
  border: 1px solid #e6ebf2;
  border-radius: 8px;
  height: 44px;
...
.app-initial-loader__week span:nth-child(3) {
  background: #eff6ff;
  border-color: #bfdbfe;
}

.app-initial-loader__timeline {
  display: grid;
  gap: 10px;
}

.app-initial-loader__slot {
  align-items: center;
  background: #f8fbff;
  border: 1px solid #e6ebf2;
  border-radius: 8px;
...
.app-initial-loader__slot span,
.app-initial-loader__slot strong,
.app-initial-loader__slot i {
  border-radius: 8px;
  display: block;
}
...
.app-initial-loader__slot:nth-child(2) i {
  background: var(--loader-primary);
}

.app-initial-loader__slot:nth-child(3) i {
  background: var(--loader-cyan);
}

.app-initial-loader__dock {
  display: grid;
  gap: 8px;
  grid-template-columns: repeat(4, 1fr);
}

.app-initial-loader__dock span {
  background: #eef3fa;
  border-radius: 8px;
  height: 8px;
}
