...
| Secondary | `#49BEFF` | `--color-secondary` |
| CTA/Accent | `#FF6B00` | `--color-cta` |
| Background | `#F4F6FB` | `--color-background` |
| Text | `#17233C` | `--color-text` |

**Color Notes:** Restored original royal-blue Schedule Teacher palette with orange CTA contrast.
