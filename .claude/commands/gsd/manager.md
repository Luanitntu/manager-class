...
<execution_context>
@C:/code/manager-class/.claude/gsd-core/workflows/manager.md
...
Read and execute `C:/code/manager-class/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
