...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/code/manager-class/.claude/.gsd-surface.json`
(sibling to `C:/code/manager-class/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/code/manager-class/.claude/skills/gsd-*/`.
...
(`C:/code/manager-class/.claude`), NOT the skills sub-directory (`C:/code/manager-class/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `C:/code/manager-class/.claude` as `configDir`. The skill dirs themselves live at
`C:/code/manager-class/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-C:/code/manager-class/.claude}"
SCOPE="global"
...
(i.e. `C:/code/manager-class/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/code/manager-class/.claude/.gsd-surface.json`
Install profile marker: `C:/code/manager-class/.claude/.gsd-profile`
Skill dirs: `C:/code/manager-class/.claude/skills/gsd-*/`
Engine module: `C:/code/manager-class/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/code/manager-class/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
