...
- Usage: Reference from command with `@C:/code/manager-class/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/code/manager-class/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/code/manager-class/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
