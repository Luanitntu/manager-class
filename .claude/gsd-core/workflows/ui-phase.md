...
```markdown
Read C:/code/manager-class/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/code/manager-class/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/code/manager-class/.claude/agents/gsd-ui-checker.md for instructions.
