...
```
Agent(
  prompt="Read C:/code/manager-class/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/code/manager-class/.claude/gsd-core/templates/VALIDATION.md`
