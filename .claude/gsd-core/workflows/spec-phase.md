...
ones). Reference: @C:/code/manager-class/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/code/manager-class/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/code/manager-class/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/code/manager-class/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/code/manager-class/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/code/manager-class/.claude/gsd-core/templates/spec.md.
