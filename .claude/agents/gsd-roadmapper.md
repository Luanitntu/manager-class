...
Reference full template: `C:/code/manager-class/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/code/manager-class/.claude/gsd-core/templates/state.md`.
