...
<reference>
@C:/code/manager-class/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/code/manager-class/.claude/gsd-core/references/user-profiling.md` to load:
